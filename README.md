...
- **Top RAM Consumers Radar**: Displays the active memory-hogging processes with real-time memory meters and 1-click process trimming.
...
- **Browser Caches**: Cleans Chrome, Edge, Brave, and Firefox caches without deleting cookies, bookmarks, or passwords.
- **DirectX & GPU Shader Cache**: Purges outdated compiled shader blobs (DirectX, NVIDIA, AMD).
...
- Clean, readable typography using **Plus Jakarta Sans** and **Inter** (no illegible fonts).
...
# 3. Build native C# Memory Engine
